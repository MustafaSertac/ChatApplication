...
val user=signUpAuth.currentUser
                ...
                val hashMap= hashMapOf("userid" to user!!.uid!!,"username" to name,"useremail" to email,"status" to "default","imageUrl" to "https://www.pngarts.com/files/2/Darksiders-III-PNG-Photo.png")
